package com.org.gen.day7.question1;
...
public class PrintDevData {
	...
	public static void main(String[] args) {
		...
		dv.add(new DeveloperDemo(12, "Shivam", 5, 100000));
		dv.add(new DeveloperDemo(14, "Himanshu", 10, 120000));
		dv.add(new DeveloperDemo(16, "Mukesh", 3, 70000));
		dv.add(new DeveloperDemo(13, "Bharti", 4, 60000));
		dv.add(new DeveloperDemo(111, "Abhishek", 2, 50000));
